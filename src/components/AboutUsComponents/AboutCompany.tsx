...
const AboutCompany = () => {
  return (
    <div className="mt-20 mb-10 lg:mx-14 mx-8">
      <div className="grid lg:grid-cols-2  gap-7">
        <div>
          ...
          <p className="lg:mt-5 sm:mt-3 text-justify">
            Sportify is your premier online destination for high-quality sports
            accessories. We cater to athletes and fitness enthusiasts of all
            levels, offering a wide range of products designed to enhance
            performance, comfort, and style. Our curated selection features top
            brands and the latest innovations in sports gear, ensuring that our
            customers have access to the best tools for success. At Sportify, we
            are passionate about fostering a supportive community, providing
      ...
      <div className="my-5">
        <h1 className="text-2xl font-bold text-lime-500">OUR MISSION</h1>
        <p className="text-justify">
          ...
          trends and advancements in sports technology, Sportify aims to be the
          go-to destination for all your sporting needs.
        </p>
      </div>
      <div className="my-5">
        <h1 className="text-2xl font-bold text-lime-500">OUR VISION</h1>
        <p className="text-justify">
          Our vision at Sportify is to become the leading online destination for
          sports accessories, recognized for our unwavering commitment to
